            ...
            <div class="content">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="col-lg-4"><h5 class="panel-title">Stock Listing</h5></div>
                        <div class="col-lg-1"><input type="checkbox" name="isAnyOnecanReview" id="isAnyOnecanReview"></div>
