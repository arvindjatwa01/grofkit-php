...
ss=\"col-md-6 col-sm-12\" style=\"float:right;\"><ul class=\"pagination bootpag\" style=\"float:right;\">";
			...
			if ($page > 1)
				...
				$pagination .= "<li><span class=\"disabled\"><i class=\"fa fa-angle-left\"></i>Previous</span></li>";
			...
			if ($page < $counter - 1)
				...
				$pagination .= "<li><span class=\"disabled\">Next<i class=\"fa fa-angle-right\"></i></span></li>";
		...
		<div class="span6"><div class="dataTables_paginate paging_bootstrap pagination"><ul class="list-inline list-unstyled">';
			...
			if ($page > 1)
				...
				$pagination .= '<li class="prev disabled"><a href="javascript:void(0);">← Previous</a></li>';
			...
			if ($page < ($counter - 1)) {
				...
				$pagination .= '<li class="next disabled"><a href="javascript:void(0);">Next → </a></li>';
			}
