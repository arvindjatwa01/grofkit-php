...
<body class="h-100">
    ...
    <div class="h-100 d-flex flex-column justify-content-between">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center border-bottom">
                ...
                $itemName = $_GET['item'];
                $urlitemId = $_GET['id'];
                $strLoadConditions = " AND ite_Id ='".base64_decode($urlitemId)."'";
                ...
                <div class="col-lg-6 ">
                    ...
                    <div id="carouselExampleIndicators"
                        ...
                        <div class="carousel-inner">
                            ...
                            <img src="assets1/images/yellow-diamond-magic-masala-chips-500x500.png" class="d-block img-fluid mx-auto" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="assets1/images/yellow-diamond-nimbu-masala-chips-500x500.png" class="d-block img-fluid mx-auto" alt="...">
                          </div> -->
                        </div>
                ...
                <div class="col-lg-4 about-product-detail py-lg-3 pt-4 pb-3">
                    <h6 class="fs-4 fw-500 mb-2">
                        <?php echo $rowSize['ite_Name']; ?><?php if($stockRow['stl_Volumns'] <= 0){ ?><span
                            class="out-stock top-50 ms-4 translate-middle-y text-white" style="font-size: .85rem;">Out
                            of Stock</span><?php }?> </h6>
                    <h6 class="fs-4 text-theme mb-2 fw-500">
                        <span>&#8377;</span>
                        <?php 
                            $selectAttPriceSql = "SELECT GROUP_CONCAT(iteAtt_value ORDER BY iteAtt_value ASC) as defaultAtt FROM `attributeitem` WHERE `isdefault` =1 AND `iteAtt_itemID`='".base64_decode($urlitemId)."'";
                            $selectAttPriceRes = $dbh->query($selectAttPriceSql);
                            $selectAttPriceData = $selectAttPriceRes->fetch();

                            $itemAttributePriceSql = $dbh->query("SELECT attPrice_Price FROM attributeprice WHERE attPrice_itemId='".base64_decode($urlitemId)."' AND attPrice_attvaluesId='".$selectAttPriceData['defaultAtt']."'");
                        ...
                        ?>
                        <span id="itemratedisyply"><?php echo number_format($itemPrice, 2); ?></span>
                    ...
                    <div class="quantity-detail-product d-inline-flex align-items-center mb-1">
                    ...
                    <?php 
                        ...
                        ?>
                    <div
                        class="weight-products <?php echo $mainClass; ?> same-style-details d-flex align-items-start flex-wrap mb-1">
                        ...
                        <div class="d-flex flex-wrap attributecolor">
                            <?php
                        $strLoadAttValueCondition = " AND iteAtt_itemID ='". ($rowSize['ite_Id'])."' AND `iteAtt_attid`='". ($rowAtt['iteAtt_attid'])."' GROUP BY attd_value";
                        $strAttValueFileds = "attributedtl.attd_value,`attributeitem`.`isdefault`,`attributeitem`.`iteAtt_attid`,`attributedtl`.`attd_id`";
                        ...
                        $resSelectedAttValuseList =$class_common->loadMultipleDataByTableName($strLoadAttValueCondition, $strAttValueFileds, $strAttValueJoinCondition, 0, '', 'attributeitem');
                            foreach($resSelectedAttValuseList as $rowAttValue){
                                ...
                                $cartAttSql = "SELECT cart.cart_Id,cartdtl.cartDtl_attvalue FROM cart LEFT JOIN cartdtl ON cartdtl.cartDtl_cartid=cart.cart_Id WHERE cart_UserID = '$userId' AND cart_itemId = '$itemId'";
                                $cartAttRes=$dbh->query($cartAttSql);
                                $cartAttDataFetch = $cartAttRes->fetchAll();
                                // print_r($cartAttDataFetch['cartDtl_attvalue']);
                                // if(array_search($rowAttValue['attd_id'], $cartAttDataFetch['cartDtl_attvalue'])){
                                //     $attActive = "active";
                                // }else{
                                //     $attActive= '';
                                // }
                                $cartValues = array();
                                if(count($cartAttDataFetch) > 0){
                                    foreach($cartAttDataFetch as $cartAttValuesList){
                                        $cartValues[] = $cartAttValuesList['cartDtl_attvalue'];
                                    }
                                }
                                // print_r($cartValues);
                                if(count($cartAttDataFetch) > 0){
                                    if(in_array($rowAttValue['attd_id'], $cartValues)){
                                        $defaultactive = "active";
                                    }else{
                                        $defaultactive ='';
                                    }
                                }else{
                                    if($rowAttValue['isdefault'] == 1){
                                            $defaultactive = "active"; 
                                        }else{
                                            $defaultactive = "";
                                        } 
                                ...
                                //     $defaultactive = "";
                                // }
                                // print_r($cartAttValuesList);
                                // if(array_search($rowAttValue['attd_id'],$cartAttValuesList)){
                                //     $attActive = "active";
                                // }else{
                                //     $attActive= '';
                                // }
                        ...
                        ?>
                            <a class="attributeValue <?php echo $defaultactive; ?>"
                                data-attid="<?php echo $rowAttValue['iteAtt_attid']; ?>"
                    ...
                    <?php }?>
                    <!-- <div class="flavoured-products same-style-details  d-flex align-items-start flex-wrap my-3">
                        ...
                        <div class="d-flex flex-wrap">
                            <a class="active">Cream n Onion</a>
                            <a class="">Tom-Chi</a>
                    ...
                    // if($stockRes->rowCount() >0){
                        ...
                        if($stockRow['stl_Volumns'] <= 0){ ?>
                        <a href="#"
                            class=" fs-6 add-cart-btn d-flex justify-content-center align-items-center out-stock-card"
                            data-value="Added to cart" style='pointer-events: none;'>
                            Add to
                        ...
                        <?php }else{
                            ...
                            if($checkloginadmin){
                                ...
                                if($resUserItem){ ?>
                        <a href="cart.php" class=" fs-6 add-cart-btn d-flex justify-content-center align-items-center"
                            data-value="Added to cart"> Added to
                            Cart <img src="assets1/images/shopping-cart.png" alt=""> </a>
                        <?php 
                                }else{ ?>
                        <a class=" fs-6 add-cart-btn d-flex justify-content-center align-items-center"
                            data-itemid='<?php echo $itemId; ?>' data-unitid='<?php echo $unitId; ?>'
                            data-value="Add to cart"> <span>Add to Cart</span> <img
                                src="assets1/images/shopping-cart.png" alt=""> </a>
                        <?php 
                                }
                            }else{ ?>
                    ...
                    <div class="d-flex flex-column my-2  w-100">
                        ...
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <div class="progress w-60 ms-2">
                                ...
                                <div class="progress-bar  bg-success" role="progressbar"
                                    style="width:<?php echo ($Rating5Row['ratingFive']/$countRow['totalReview'])*100; ?>%"
                        ...
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <?php 
                                ...
                                ?>
                            <div class="progress w-60 ms-2">
                                <div class="progress-bar  bg-1" role="progressbar"
                                    style="width:<?php echo ($Rating4Row['ratingFour']/$countRow['totalReview'])*100; ?>%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <?php 
                                ...
                                ?>
                            <div class="progress w-60 ms-2">
                                <div class="progress-bar  bg-2" role="progressbar"
                                    style="width:<?php echo ($Rating3Row['ratingThree']/$countRow['totalReview'])*100; ?>%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <?php 
                                ...
                                ?>
                            <div class="progress w-60 ms-2">
                                <div class="progress-bar  bg-3" role="progressbar"
                                    style="width:<?php echo ($Rating2Row['ratingTwo']/$countRow['totalReview'])*100; ?>%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="d-flex w-100 justify-content-center align-items-center">
                            ...
                            <?php 
                                ...
                                ?>
                            <div class="progress w-60 ms-2">
                                <div class="progress-bar  bg-4" role="progressbar"
                                    style="width:<?php echo ($Rating1Row['ratingOne']/$countRow['totalReview'])*100; ?>%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
            ...
            100%;">
                <div class="modal-content">
                    ...
                    <div class="modal-header border-bottom-0">
                        <div class="btn-close ms-auto" data-bs-dismiss="modal" style="cursor: pointer;"></div>
    ...
    <script src="assets1/js/productdet.js">
